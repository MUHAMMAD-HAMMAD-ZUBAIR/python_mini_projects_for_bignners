# ------------------------------------------------------
# 🔐 Password Hashing Login System with Extra Features
# 👨‍💻 Author: Muhammad Hammad Zubair
# 📅 Date: May 2025
# 📘 Description:
#     This program allows user registration and login with hashed passwords.
#     It includes retry attempt limits, password strength checking, and activity logging.
# ------------------------------------------------------
...
# -------------------------------------
# 🔐 Login Function with Retry Limit
# -------------------------------------
